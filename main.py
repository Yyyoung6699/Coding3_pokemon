...
class Config():
    ...
    result_save_path = 'results_3/' #生成图像保存的路径
    d_net_path = 'snapshots_3/dnet.pth' #判别网络权重文件保存的路径
    g_net_path = 'snapshots_3/gnet.pth' #生成网络权重文件保存的路径
    img_path = 'dataset/pokemon' #源图像文件路径
...
if not os.path.exists('results_3'):
    os.mkdir('results_3')  #生成results文件夹
if not os.path.exists('snapshots_3'):
    os.mkdir('snapshots_3') #生成snapshots文件夹
